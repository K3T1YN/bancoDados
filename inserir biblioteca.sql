...
INSERT INTO Endereco (rua, numero, complemento, bairro, cidade, cep, userID) VALUES 
		("Rua A", "123", "Apto1", "Bairro 1", "Cidade1", "12345", "1"),
        ("Rua B", "234", "NULL", "Bairro 2", "Cidade 2", "23456", "2"),
        ("Rua C", "345", "Apto2", "Bairro 3", "Cidade 3", "34567", "3"),
        ("Rua D","456","Casa2","Bairro 4", "Cidade4", "45678", "4"),
		("Rua E","567","NULL","Bairro 5", "Cidade 5", "56789", "5");
